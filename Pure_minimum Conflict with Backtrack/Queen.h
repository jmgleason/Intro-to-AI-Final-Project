...
Queen findNewPosition(Queen _selectedQueen, Queen grid[numOfQueens][numOfQueens], bool AvoidMap[numOfQueens][numOfQueens] ){
	...
	for( selectedQueen.pos.y=0; selectedQueen.pos.y<numOfQueens; ++selectedQueen.pos.y ){
		if( AvoidMap[newQueen.pos.x][selectedQueen.pos.y] == false ){
